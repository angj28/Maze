...
class ExamplesMaze {
  ...
  void testGetAllEdges(Tester t) {
    ...
    t.checkExpect(this.g2.getAllEdges(), new ArrayList<Edge>(
        Arrays.asList(this.e1, this.e1, this.e2)));
  ...
  void testFind(Tester t) {
    ...
    this.hm.put(this.g0.vertices.get(0), this.g0.vertices.get(1));
    t.checkExpect(this.g0.find(this.hm, this.g0.vertices.get(0)), null);
    t.checkExpect(this.g0.find(this.hm, this.g0.vertices.get(1)), null);
    t.checkExpect(this.g0.find(this.hm, this.g0.vertices.get(2)), null);
  }
  ...
  void testPlaceEdges(Tester t) {
    ...
    this.background2.placeImageXY(
        bottomEdge, this.v1.x + (this.v1.size / 2), this.v1.y + this.v1.size);
    t.checkExpect(this.background, this.background2);
    ...
    this.background2.placeImageXY(
        rightEdge, this.v1.x + this.v1.size, this.v1.y + (this.v1.size / 2)); 
    t.checkExpect(this.background, this.background2);
  }
}